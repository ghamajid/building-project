  ...
  if (dt_permission_table.length) {
    var dt_permission = dt_permission_table.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">'+trans('lang.Add New Permission')+'</span>',
  ...
  const fv = FormValidation.formValidation(addNewPermissionForm, {
    fields: {
      name: {
        validators: {
          notEmpty: {
            message: trans_choice('validation.required',1,{attribute:trans('lang.Permission Name')})
          }
        }
      },
    },
